...
print "Accuracy of the Classifier :",accuracy_score(pred,labels_test)
print "Percision of the Classifier :",precision_score(pred,labels_test)
print "Recall of the Classifier :",recall_score(pred,labels_test)




# clf = AdaBoostClassifier()
# #Parameter Grid that GridSearchCV goes through
# params = [{'algorithm':['SAMME'],
#          'n_estimators':[25,35,40,50,75,100],
#              'learning_rate':[0.1,0.25,0.5,0.75,1]},
#           {'algorithm':['SAMME.R'],
